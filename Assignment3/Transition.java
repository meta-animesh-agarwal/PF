...
public class Transition {
	 ...
	 * @param {State}initialState state object depicting initial state 
	 * @param {State}finalState state object depicting final state
	 * @param {Event}event event object depicting occurred event
	 */
