...
public class Workflow {
     ...
     * @param {String}workflow_name string has the name of the workflow
     */
	 ...
	 * @param {Event}event the current event that occurred
	 */
	 ...
	 * @param {Event}event object of event class in which variable ok or reject have to 
	 * be changed
	 * @param {String}eventStatus name of the event to be checked
	 ...
	 * @param {State}state - passed state
	 * @return - boolean type
	 */
