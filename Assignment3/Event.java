...
public class Event {
    ...
    * @param {boolean}ok - value of ok variable
    */
    ...
    * @param {boolean}ok value of reject variable
    */
	 ...
	 * @param {String}eventName contains the name of the event
	 */
     ...
     * @param {String}eventStatus name of the event
     */
