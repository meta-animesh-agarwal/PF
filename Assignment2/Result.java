...
public class Result {
	 ...
	 * @param {String}option - the option for which the  count is to be counted
	 */
	 ...
	 * @param {List<String>}optionList- list of options
	 */
	 ...
	 * @param {String}option - the option for which percentage has been calculated
	 * @param {String}percent - percentage of that particular option
	 */
